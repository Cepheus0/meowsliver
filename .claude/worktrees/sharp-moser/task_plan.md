...
- [x] Define a DB-backed snapshot layer for assets and liabilities from the accounts table
- [x] Define a DB-backed snapshot layer for investment holdings from the accounts table
- [ ] Replace snapshot metadata with a real holdings / valuation ledger
...
4. Replace the current account-snapshot model with full holdings and valuation history where needed.
